...
func GetMoviesOffsetPaging(w http.ResponseWriter, r *http.Request) {
	...
	movies, err := service.GetMoviesByOffset(r.Context(), page, size)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func GetMoviesCursorPaging(w http.ResponseWriter, r *http.Request) {
